...
const getImdbInfo = async (title) => {
  ...
  const { id: imdbId, title: name, vote_average: votes, poster_path: posterPath, backdrop_path: backdropPath } = movie;
  ...
  return { imdbId, title: name, votes: votesParsed, poster, backdrop }; // eslint-disable-line
};
